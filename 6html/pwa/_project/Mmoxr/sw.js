...
const CASH_LIST = ['js', 'css', 'jpg', 'png', 'jpeg', 'gif', 'svg', 'ttf', 'woff', 'eot', 'ico', 'webmanifest'];
...
self.addEventListener('fetch', function(e) {
    ...
    console.log('cache ' + e.request.url); e.respondWith(caches.match(e.request).then(function(response) {
