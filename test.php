...
// 排个序
$a = '140,342,408,370,282,231,271,269,406,418,300,132,134,178,159,181,180,183,136,164,322,412,424,366,249,436,442,444,446,448,450,452,454,348,456,368,157,290,458,460';
// $a = explode(',', $a);
// sort($a);
// $a = implode(',', $a);
// debug($a);
