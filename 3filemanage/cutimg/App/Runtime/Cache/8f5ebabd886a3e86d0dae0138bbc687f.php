...
<title>剪裁图片</title>
  ...
  <meta name="description" content="" />
	<script language="javascript" type="text/javascript" src="__ROOT__/Resource/js/drag.js"></script>
</head>
<body>
<div class="pleft">
<div class="leftspace">
<table width="100%" border="0">
	<tr>
		...
		<img id="cut_img" style="position: relative; top: -266px; left: 0px"
			src="<?php echo ($imgurl); ?>" /></div>
		<table cellspacing="0" cellpadding="0">
			<tr>
				<td><img style="margin-top: 5px; cursor: pointer;"
					src="<?php echo C("imglink");?>avatar/_h.gif" alt="图片缩小"
					onmouseover=
						this.src = '<?php echo C("imglink");?>avatar/_c.gif';
					onmouseout=
						this.src = '<?php echo C("imglink");?>avatar/_h.gif';
					onclick=
						imageresize(false);
					/></td>
				<td><img id="img_track"
					style="width: 250px; height: 18px; margin-top: 5px"
					src="<?php echo C("imglink");?>avatar/track.gif" /></td>
				<td><img style="margin-top: 5px; cursor: pointer;"
					src="<?php echo C("imglink");?>avatar/+h.gif" alt="图片放大"
					onmouseover=
					this.src = '<?php echo C("imglink");?>avatar/+c.gif';
				onmouseout=
					this.src = '<?php echo C("imglink");?>avatar/+h.gif';
				onclick=
					imageresize(true);
/></td>
			</tr>
		...
		<img id="img_grip"
			...
			src="<?php echo C("imglink");?>avatar/grip.gif" />
